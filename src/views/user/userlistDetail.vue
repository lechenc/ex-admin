<template>
  <div class="userdetail-container">
    ...
    <el-card class="box-card">
      <div class="box-card-con">
        ...
        <div v-if="!isModify">
          <div>
            登录状态：<span>
              <el-switch v-model="is_login" :disabled="true" active-color="#13ce66" inactive-color="#ff4949" @click.native="handleUpdate('is_login')"></el-switch>
            </span>
          </div>
          <div>
            交易状态：<span>
              <el-switch v-model="is_exchange" disabled active-color="#13ce66" inactive-color="#ff4949" @click.native="handleUpdate('is_exchange')"></el-switch>
            </span>
          </div>
          <div>
            法币状态：<span>
          ...
          <div>
            提币状态：<span>
              <el-switch v-model="is_draw" disabled active-color="#13ce66" inactive-color="#ff4949" @click.native="handleUpdate('is_draw')"></el-switch>
            </span>
          </div>
          <div>
            广告状态：<span>
    ...
    <el-row class="sac-row">
      <el-button v-if="btnArr.includes('resetKYC')" @click="resetKYC" type="primary">重置初级KYC</el-button>
      <el-button v-if="btnArr.includes('resetGoogleCode')" @click="resetGoogleCode" type="primary">重置谷歌秘钥</el-button>
    </el-row>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="用户资产" name="assets">
        <template>
          ...
          <div class="container-footer">
            <el-pagination background @current-change="goAssetsPage" layout="total, prev, pager, next, jumper" :current-page="assets_curr_page" :page-size="pageSize" :total="assets_total"> </el-pagination>
          </div>
        </template>
      </el-tab-pane>
      <el-tab-pane label="邀请明细" name="share">
        ...
        <div class="container-footer">
          <el-pagination background @current-change="goInvitePage" layout="total, prev, pager, next, jumper" :current-page="invite_curr_page" :page-size="pageSize" :total="invite_total"> </el-pagination>
        </div>
      </el-tab-pane>
    </el-tabs>
