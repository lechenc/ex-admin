 ...
 * @LastEditTime: 2020-10-19 18:10:14
...
<template>
  <div class="rechargeCustom-container">
...
import { rechargeCustomCol, rechargeCustomConfig } from '@/config/column/customer';
...
export default {
  ...
  mounted() {
    ...
    this.searchCofig = this.$util.clone(rechargeCustomConfig);
