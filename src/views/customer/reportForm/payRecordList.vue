<template>
  <div class="payRecordList-container">
    <div class="container-top">
      <Bsearch :configs="searchCofig" @do-search="doSearch" @do-reset="doReset" />
    </div>
    <!-- <div class="container-btn" v-if="isCURDAuth">
      <el-button type="primary" size="medium" @click="addLine">异常币付记录</el-button>
    </div> -->
    <div>
...
import { payRecordListCol, payRecordListColNoBtn, payRecordListConfig } from '@/config/column/customer';
...
export default {
  ...
  mounted() {
    let authObj = this.$util.getAuthority('PayRecordList', payRecordListCol, payRecordListColNoBtn);
    ...
    this.searchCofig = this.$util.clone(payRecordListConfig);
