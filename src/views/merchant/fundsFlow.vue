 ...
 * @LastEditTime: 2020-08-05 18:35:30
...
import { fundsFlowCol, fundsFlowColNoBtn, fundsFlowConfig } from '@/config/column/merchant'
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const res = await $api.queryAmountFlowPage(query_data)
      if (res) {
  ...
  mounted() {
    let authObj = this.$util.getAuthority('FundsFlow', fundsFlowCol, [])
    this.btnArr = authObj.btnArr || []
    this.configs = fundsFlowCol
    this.searchCofig = fundsFlowConfig
