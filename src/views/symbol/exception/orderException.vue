...
-->
<template>
  <div class="orderException-container">
...
import { orderExceptionCol, orderExceptionConfig } from '@/config/column/symbol'
...
export default {
  ...
  methods: {
    ...
    async queryData(params) {
      ...
      const res = await $api.apiGetorderExceptionList(params)
  ...
  mounted() {
    let authObj = this.$util.getAuthority('OrderException', orderExceptionCol, [])
    this.btnArr = authObj.btnArr || []
    this.configs = orderExceptionCol
    this.searchCofig = this.$util.clone(orderExceptionConfig)
    // 初始化今天，和昨天的时间
