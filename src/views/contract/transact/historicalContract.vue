<template>
  <div class="historicalContract-container">
...
import { historicalContractCol, historicalContractConfig } from '@/config/column/contract';
...
export default {
  ...
  mounted() {
    this.configs = historicalContractCol;
    this.searchCofig = this.$util.clone(historicalContractConfig);
    // 初始化今天，和前天的时间
