        ...
        <el-row :span="24">
          ...
          <el-col :span="12">
            <el-form-item label="计价币" :label-width="formLabelWidth" prop="marketId">
              <el-select v-model="cForm.marketId" placeholder="" wdith="20%" :disabled="true">
...
import { coinContractCol, coinContractColNoBtn } from '@/config/column/contract';
    ...
    addCoin() {
      ...
      this.$nextTick(() => {
        ...
        this.cForm = {
          ...
          initPrice: '',
          coinId: '',
          marketId: this.defaultCoin[0].value,
          faceValue: '',
          // makerFee: '',
          takerFee: '',
          pricePrecision: '',
