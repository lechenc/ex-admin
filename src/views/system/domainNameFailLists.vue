<template>
  <div class="domainNameFailLists-container">
...
import { domainNameFailListsCol, domainNameFailListsConfig } from '@/config/column/system';
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const res = await $api.getDomainNameFailListsList(params);
      if (res) {
  ...
  mounted() {
    this.configs = domainNameFailListsCol;
    this.searchCofig = this.$util.clone(domainNameFailListsConfig);
    // 初始化今天，和前天的时间
