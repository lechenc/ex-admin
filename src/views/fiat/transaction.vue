 ...
 * @LastEditTime: 2020-08-05 20:33:53
...
import { transactionCol, transactionColNoBtn, transactionConfig } from '@/config/column/fiat';
...
export default {
  ...
  mounted() {
    // let authStatus = this.$util.getAuthority("FiatTransaction");
    // if (authStatus === 2) {
    //   this.configs = transactionColNoBtn;
