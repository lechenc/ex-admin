  ...
  <div class="acceptanceChannelList-container">
    ...
    <div>
      <div class="container-btn">
        <el-button type="primary" v-if="btnArr.includes('add')" size="medium" @click="createVisible = true">创建渠道</el-button>
      </div>
    ...
    <!-- 创建渠道 -->
    <el-dialog :close-on-click-modal="false" title="创建渠道" :visible.sync="createVisible" width="550px">
      <div>
        <el-form :model="ruleForm" ref="ruleForm" :rules="formRules" label-width="140px">
          <el-form-item label="渠道名称" prop="channelName">
            <el-input v-model="ruleForm.channelName" autocomplete="off" placeholder="请输入渠道名称"></el-input>
          </el-form-item>

          <el-form-item label="承兑商UID" prop="advertiserUid">
            <el-input @input="checkVal('advertiserUid')" v-model="ruleForm.advertiserUid" autocomplete="off" placeholder="请输入一级承兑商UID"></el-input>
          </el-form-item>
        </el-form>
      </div>
