 ...
 * @LastEditTime: 2020-09-28 11:03:37
...
<template>
  <div class="customerFlow-container">
...
export default {
  ...
  activated() {
    ...
    let authObj = this.$util.getAuthority('CustomerAccount', customerFlowCol, [])
