...
import { distributionCol, distributionColNoBtn, distributionConfig } from '@/config/column/warehouse';
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const res = await $api.warehousebonusDetail(params);
      if (res) {
    ...
    initFunc() {
      this.configs = distributionCol;
      this.searchCofig = this.$util.clone(distributionConfig);
