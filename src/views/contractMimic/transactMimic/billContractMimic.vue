...
import { billContractMimicCol, billContractMimcConfig } from '@/config/column/contractMimic';
...
export default {
  ...
  mounted() {
    this.configs = billContractMimicCol;
    this.searchCofig = this.$util.clone(billContractMimcConfig);
    // 初始化今天，和前天的时间
