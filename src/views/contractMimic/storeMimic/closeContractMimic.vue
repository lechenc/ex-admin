...
import { closeContractMockCol, closeContractMockConfig } from '@/config/column/contractMimic';
...
export default {
  ...
  mounted() {
    this.configs = closeContractMockCol;
    this.searchCofig = this.$util.clone(closeContractMockConfig);
    // 初始化今天，和前天的时间
